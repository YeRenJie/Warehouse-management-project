...
namespace Storehouse {
    ...
    public partial class StorehouseDataSet1 : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserRow AddUserRow(string UserName, string UserPwd, string UserType) {
...
namespace Storehouse.StorehouseDataSet1TableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[User] WHERE (([UserID] = @Original_UserID) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)) AND ((@IsNull_UserPwd = 1 AND [UserPwd] IS NULL) OR ([UserPwd] = @Original_UserPwd)) AND ([UserType] = @Original_UserType))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([UserName], [UserPwd], [UserType]) VALUES (@UserName, @" +
                "UserPwd, @UserType);\r\nSELECT UserID, UserName, UserPwd, UserType FROM [User] WHE" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [UserName] = @UserName, [UserPwd] = @UserPwd, [UserType] = @UserType WHERE (([UserID] = @Original_UserID) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)) AND ((@IsNull_UserPwd = 1 AND [UserPwd] IS NULL) OR ([UserPwd] = @Original_UserPwd)) AND ([UserType] = @Original_UserType));
SELECT UserID, UserName, UserPwd, UserType FROM [User] WHERE (UserID = @UserID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Storehouse.Properties.Settings.Default.StorehouseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, UserName, UserPwd, UserType FROM dbo.[User]";
        ...
        public virtual int Fill(StorehouseDataSet1.UserDataTable dataTable) {
        ...
        public virtual StorehouseDataSet1.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StorehouseDataSet1.UserDataTable dataTable = new StorehouseDataSet1.UserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StorehouseDataSet1.UserDataTable dataTable) {
        ...
        public virtual int Delete(int Original_UserID, string Original_UserName, string Original_UserPwd, string Original_UserType) {
        ...
        public virtual int Insert(string UserName, string UserPwd, string UserType) {
            if ((UserName == null)) {
        ...
        public virtual int Update(string UserName, string UserPwd, string UserType, int Original_UserID, string Original_UserName, string Original_UserPwd, string Original_UserType, int UserID) {
            if ((UserName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string UserName, string UserPwd, string UserType, int Original_UserID, string Original_UserName, string Original_UserPwd, string Original_UserType) {
            return this.Update(UserName, UserPwd, UserType, Original_UserID, Original_UserName, Original_UserPwd, Original_UserType, Original_UserID);
        }
    }
